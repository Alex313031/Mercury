...
home-prefs-content-header = Mercury Home Content
home-prefs-content-description = Choose what content you want on your Mercury Home screen.
...
sync-engine-addons =
    .label = Add-ons
    .tooltiptext = Extensions and themes for Mercury desktop
    .accesskey = A
